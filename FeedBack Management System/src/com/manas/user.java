...
import com.manas.add;
import com.manas.adm_login;
...
public class user extends JFrame {
	...
	public user() {
		...
		JLabel label2 = new JLabel(" Welcome to FEEDBACK Portal");
		...
		btnNewButton.setFont(new Font("Lato", Font.BOLD, 40));
		btnNewButton.setBounds(653, 372, 300, 150);
		...
		btnNewButton_1.setFont(new Font("Lato", Font.BOLD, 61));
		btnNewButton_1.setBounds(36, 372, 500, 150);
